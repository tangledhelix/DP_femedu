...
* [x] Handle any drop-caps ([wiki](https://www.pgdp.net/wiki/DP_Official_Documentation:PP_and_PPV/Easy_Epub/Dropcaps))
...
* [x] Optional: kepub conversion with Calibre
...
* [x] Mac
  * [x] Adobe Digital Editions (epub2)
  * [x] Apple Books
...
* [x] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID654f9c263a5aa), select SR time period, upload `femedu-sr.zip`
