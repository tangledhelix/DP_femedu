...
* [x] Use `File → Save a Copy As` to make `femedu.html`
...
* [x] Re-open `femedu-utf8.txt` (if not still open).
...
* [x] Open `femedu.html` that was saved previously.
...
* [ ] Using Regex Library and my `abbr.json` file, add `abbr` tags as appropriate. ([Reference](https://www.pgdp.net/wiki/Accessibility_Recipes/Abbreviations))
  * Note: if an `<abbr>` occurs inside a `smcap`, or `allsmcap`-classed element, `abbr` CSS overrides the smallcaps. In this case add the relevant `smcap` or `allsmcap` class to the `<abbr>` element as well.
...
* [ ] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID654f9c263a5aa), select SR time period, upload `femedu-sr.zip`
...
* [ ] Add **anonymized** files to git, e.g. `femedu-smoothread01.txt`
...
* [ ] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID654f9c263a5aa))
...
* [ ] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID654f9c263a5aa)
